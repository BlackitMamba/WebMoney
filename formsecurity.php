...
<html>
  <head>
    ...
    body{
        ...
        align-items: center;
        background: linear-gradient(to right, #ffe600,#ffa600,#ff9900, #ff8000);
    }
    .container{
    ...
    input[type="text"]:hover, input[type="password"]:hover {
        background-color: rgb(206, 167, 82);
        cursor: text;
        font-style: inherit;
    }
    ...
    input[type="submit"],.xd {
        ...
        background:linear-gradient(to right,rgb(190, 136, 19),#efff0d);
        border: none;
        color: #fff;
        padding: 10px 20px;
        font-size: 18px;
    ...
    input[type="submit"]:hover,.xd:hover {
      color: #00ff15;
        background:linear-gradient(to right,#bcc721,rgb(148, 54, 10));
    }
    .container {
  position: relative;
  width: 500px;
...
.square:nth-child(3):hover {
  ...
  <div class="box">
    ...
    <form action="cantidad.php" method="post">
      ...
      <input type="submit" value="Login" name="Siguiente">
